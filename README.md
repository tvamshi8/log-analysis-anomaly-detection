...
1. **Clone the Repository**
    ```bash
    git clone https://github.com/vamshi-tummala/log-analysis-anomaly-detection.git
...
Vamshi Tummala is a Business Analyst and Data Science graduate student with experience in transforming operational data into actionable business insights. With a background in SQL, Power BI, and Python (Pandas, NumPy), Vamshi focuses on developing analytical solutions to improve reporting accuracy and strengthen KPI visibility.
